/**
 * @file lista_e_ord_teste.c
 * 
 * Aplicação para testes da estrutura lista encadeada ordenada
 * 
 * Para executar, proceda conforme a seguir:
 * Compilação: gcc lista_e_teste.c ../ed/lista_e_ord.c ../ed/item.c
