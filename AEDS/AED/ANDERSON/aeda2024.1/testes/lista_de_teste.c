/**
 * @file lista_ee_teste.c
 * 
 * Aplicação para testes da estrutura lista duplamente encadeada
 * 
 * Para executar, proceda conforme a seguir:
 * Compilação: gcc lista_de_teste.c ../ed/lista_de.c ../ed/item.c
...
int main() {
    ...
    while(!lista_vazia(l1)) {
        //lista_remover(l1, 1, &rem);
        lista_remover(l1, lista_tamanho(l1), &rem);
        printf("Lista: ");
        lista_exibir(l1);
        printf("\n");
    }
