...
{	
	if(!treeIsEmpty(t))
	{
		//return (estritamenteBinaria(t->sae)!=NULL && estritamenteBinaria(t->sad)!=NULL);
	}
}
...
int main()
{
    ...
    //retira(80,&t);/*Retira um elemento da árvore*/
	
	if(estritamenteBinaria(t))
