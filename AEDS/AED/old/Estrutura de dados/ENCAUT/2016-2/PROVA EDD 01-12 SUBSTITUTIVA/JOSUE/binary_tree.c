...
int treeIsEmpty(Tree* t)
{
  ...
  return t == NULL;
   ...
   // função que verifica se a arvore e estritamente binária. No qual se o nó tiver filho a esquerda e direita é estritamente binaria.
   //
int verifica ( Tree* t, no * tree){
	
	if ( tree*sad!= NULL && tree*sae!= NULL)
	
	insertTree(&(no*t)->sae, num) ;
	insertTree(&(no*t)->sad, num);
