...
\section*{Questões}
\begin{enumerate}
	\item (2,5 pontos) Determine o que a seguinte função recursiva calcula. Escreva uma função iterativa para atingir o mesmo objetivo.
...
\item (2,5 pontos) Crie um programa que receba um vetor de números reais com 100 elementos.
